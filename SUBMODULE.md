# Git Submodule: sageTSDB

⚠️ **This directory is a Git submodule** - it's a separate repository!

## Repository Information

- **Name:** packages/sage-middleware/src/sage/middleware/components/sage_tsdb/sageTSDB
- **Repository:** https://github.com/intellistream/sageTSDB.git
- **Branch:** main-dev
- **Path:** `packages/sage-middleware/src/sage/middleware/components/sage_tsdb/sageTSDB`
...
git commit -m "chore: update sageTSDB submodule reference"
git push origin main-dev
```
...
cd ../../../../../../../
git add packages/sage-middleware/src/sage/middleware/components/sage_tsdb/sageTSDB
git commit -m "chore: update sageTSDB to latest"
```
...
**Solution:** 
```bash
cd packages/sage-middleware/src/sage/middleware/components/sage_tsdb/sageTSDB  # Enter the submodule first
git add .
...
git add packages/sage-middleware/src/sage/middleware/components/sage_tsdb/sageTSDB
git commit -m "chore: update sageTSDB reference"
```
