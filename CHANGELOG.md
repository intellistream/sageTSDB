...
### Changed
- Cleaned up root directory: removed stale docs (`DOCUMENTATION_CLEANUP_SUMMARY.md`, `RELEASE_NOTES_v0.1.5.md`, `CMakeLists.txt.backup`, `SETUP.md`)
- Added `CHANGELOG.md` for tracking PyPI release notes
...
[Unreleased]: https://github.com/intellistream/sageTSDB/compare/v0.1.6...HEAD
[0.1.6]: https://github.com/intellistream/sageTSDB/compare/v0.1.5...v0.1.6
